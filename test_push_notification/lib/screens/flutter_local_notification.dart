...
class FlutterLocalNotification extends StatefulWidget {
  @override
  _FlutterLocalNotificationState createState() =>
      _FlutterLocalNotificationState();
}

class _FlutterLocalNotificationState extends State<FlutterLocalNotification> {
